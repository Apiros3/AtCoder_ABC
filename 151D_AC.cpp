...
int main()
{
    ...
    rep(i,0,H*W) { 
        ...
        while (!que.empty()) {
            ...
            ll arrx[] = {0,1,0,-1}, arry[] = {1,0,-1,0};
            if (v%W != 0 and dist[v-1] == -1 and S[v/W][v%W - 1] == '.') {
                dist[v-1] = dist[v] + 1;
                que.push(v-1);
            } 
            if (v%W != W-1 and dist[v+1] == -1 and S[v/W][v%W + 1] == '.') {
                dist[v+1] = dist[v] + 1;
                que.push(v+1);
            } 
            if (v/W != 0 and dist[v-W] == -1 and S[v/W - 1][v%W] == '.') {
                dist[v-W] = dist[v] + 1;
                que.push(v-W);
            }
            if (v/W != H-1 and dist[v+W] == -1 and S[v/W + 1][v%W] == '.') {
                dist[v+W] = dist[v] + 1;
                que.push(v+W);
            }
        }
